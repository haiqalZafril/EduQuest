...
$viewUser = $currentUser; // teachers view/manage their own profile here
...
// Same handlers as student_profile but without allowing role changes
...
<head>
    ...
    <title>My Profile - eduQuest (Instructor)</title>
...
<div class="dashboard-container">
    ...
    <div class="main-content">
        <header class="header">
            <div class="header-left"><div class="header-title">eduQuest Instructor Portal</div></div>
            <div class="header-right">
                <div class="notification-icon">🔔</div>
                <div class="user-profile">
                    <div class="user-avatar-small role-teacher">
