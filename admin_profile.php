...
// Admin may view/manage other users via ?user=username
$viewUser = $currentUser;
if (isset($_GET['user']) && trim($_GET['user']) !== '') {
    $viewUser = trim($_GET['user']);
}
...
// Handle profile updates (admin can update any user they view)
...
<head>
    ...
    <title>Admin Profile - eduQuest</title>
...
<div class="dashboard-container">
    <aside class="sidebar">
        ...
        <nav>
            <ul class="nav-menu">
                <li class="nav-item">
                    <a href="admin_dashboard.php" class="nav-link <?php echo ($currentPage === 'admin_dashboard.php') ? 'active' : ''; ?>">
                        <span class="nav-icon">🛡️</span>
                        <span>Overview</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="admin_profile.php" class="nav-link <?php echo ($currentPage === 'admin_profile.php') ? 'active' : ''; ?>">
                        <span class="nav-icon">👤</span>
                        <span>My Profile</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="teacher_activity_api.php" class="nav-link <?php echo ($currentPage === 'teacher_activity_api.php') ? 'active' : ''; ?>">
                        <span class="nav-icon">📊</span>
    ...
    <div class="main-content">
        <header class="header">
            <div class="header-left"><div class="header-title">eduQuest Admin Console</div></div>
            <div class="header-right">
                <div class="notification-icon">🔔</div>
                <div class="user-profile">
                    <div class="user-avatar-small role-admin">
        ...
        <div class="content-area">
            ...
            <div class="card profile-overview">
                ...
                <div>
                    ...
                    <div class="muted">Role: <?php echo eq_h($user['role'] ?? ''); ?></div>
                </div>
            </div>
